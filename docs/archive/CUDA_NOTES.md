> Archived from origin/feature/backward-pass:cuda-bootcamp/CUDA_NOTES.md. Retained for historical/provenance reference only; numbers reflect the V1-V3 era.
